...
mcglauber_dict = {
    ...
    'roots'     :   200.0,        # collision energy (GeV)
...
music_dict = {
    ...
    'stringPreEqFlowFactor': 3.2,      # pre-Eq. flow factor
    ...
    'Y_grid_size_in_fm': 30,    # spatial range along x direction in the transverse plane 
                                # [-X_grid_size_in_fm/2, X_grid_size_in_fm/2]
    'Grid_size_in_x': 108,      # number of the grid points in x direction
    'Grid_size_in_y': 108,      # number of the grid points in y direction
    ...
    'shear_muBDep_alpha': 1.0,
    'shear_muBDep_slope': 1.2,
    ...
    'bulk_viscosity_10_width_high': 0.1,
    'bulk_viscosity_10_width_low': 0.02,
    ...
    'freeze_out_tau_start_max': 4,      # the maximum freeze-out starting time [fm/c]
    'N_freeze_out': 1,
    'eps_switch': 0.25,
}
